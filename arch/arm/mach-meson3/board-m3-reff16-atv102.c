...
#endif
{
		...
		.platform_nand_data = {
			.chip =  {
				.nr_chips = 4,
				.nr_partitions = ARRAY_SIZE(multi_partition_info_1G_or_More),
				.partitions = multi_partition_info_1G_or_More,
...
#ifndef CONFIG_XBMC_BUILD
MACHINE_START(MESON3_8726M_SKT, "Amlogic based Visson ATV-102")
