...
#define EGPIO_GPIOA_ENABLE			CBUS_REG_ADDR(PREG_PAD_GPIO3_EN_N)
#define EGPIO_GPIOA_OUTPUT			CBUS_REG_ADDR(PREG_PAD_GPIO3_O)
#define EGPIO_GPIOA_INPUT			CBUS_REG_ADDR(PREG_PAD_GPIO3_I)

#define EGPIO_GPIOB_ENABLE			CBUS_REG_ADDR(PREG_PAD_GPIO4_EN_N)
#define EGPIO_GPIOB_OUTPUT			CBUS_REG_ADDR(PREG_PAD_GPIO4_O)
#define EGPIO_GPIOB_INPUT			CBUS_REG_ADDR(PREG_PAD_GPIO4_I)

#define EGPIO_GPIOC_ENABLE			CBUS_REG_ADDR(PREG_PAD_GPIO5_EN_N)
#define EGPIO_GPIOC_OUTPUT			CBUS_REG_ADDR(PREG_PAD_GPIO5_O)
#define EGPIO_GPIOC_INPUT			CBUS_REG_ADDR(PREG_PAD_GPIO5_I)
