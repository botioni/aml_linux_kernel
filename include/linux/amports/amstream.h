...
#define AMSTREAM_IOC_SET_SYNC_ADISCON_DIFF  _IOR(AMSTREAM_IOC_MAGIC, 0x85, unsigned long)
#define AMSTREAM_IOC_SET_SYNC_VDISCON_DIFF  _IOR(AMSTREAM_IOC_MAGIC, 0x86, unsigned long)
