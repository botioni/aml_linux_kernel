...
#define VIDEO_MEM_START	(0x80000000+64*SZ_1M)	/*start at the second 64M*/


/******** AUDIODSP memory setting ************************/
#define AUDIODSP_ADDR_START		U_ALIGN(VIDEO_MEM_START)	/*audiodsp memstart*/
...
#ifdef  CONFIG_MALI_MODULE
#define MALI_MEM_SIZE		(SZ_1M*16)
#else
#define MALI_MEM_SIZE		(SZ_1M*0)
#endif 

#define MALI_ADDR_START	U_ALIGN(CODEC_ADDR_END )
#define MALI_ADDR_END		(MALI_ADDR_START+MALI_MEM_SIZE - 1)
