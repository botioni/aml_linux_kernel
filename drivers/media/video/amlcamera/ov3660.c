...
/************************************************************/
	...
	{0x5000,0xa7},    
	{0x5001,0x83},    	
	//OV3660_Lens_para(lens_para_CWF},
	//OV3660_Lens_para(lens_para_MTK},
/****************************************************************/
	{0x5800, 0x2b},
	{0x5801, 0x14},
	{0x5802, 0x12},
...
/***************************************************************/	
	...
	{0x5382,0x5a},                                         
	{0x5383,0x10}, 
	{0x5384,0x0c},//0x0b},//0x0c
	{0x5385,0x7c},//0x74},//0x7c
	{0x5386,0x88},//0x7F},//0x88                                         
	{0x5387,0x88},//0x7F},//0x88                                         
	{0x5388,0x75},//0x6D},//0x75 
	{0x5389,0x13},//0x12},//0x13 
	{0x538a,0x01},                                         
	{0x538b,0x98},  
...
//;  run @88Mhz Pclk,12.23fps
//	{0x303b, 0x16},
//	{0x303c, 0x11},
//	{0x3a09, 0xbf},
//	{0x3a0e, 0x08},
                                       
//;run@44Mhz Pclk,6.12fps as OVT Demo PCLK limitation
...
//;  run @96Mhz Pclk,13.3fps
	{0x303b, 0x18},
	{0x303c, 0x11},

	//OV3660Sensor.CapClk=96;
...
//	;                              
	...
	{0x5001, 0x23},
	 //{0x5001, CamReadCmosSensor(0x5001)&~0x20},//Disable Scaler
//;windowing                           
	{0x3800, 0x00},
	{0x3801, 0x00},
	{0x3802, 0x00},
