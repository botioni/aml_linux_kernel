...
#define SD_CMD_OUTPUT_EN_REG 		CARD_GPIO_ENABLE
#define SD_CMD_OUTPUT_EN_MASK		PREG_IO_21_MASK
#define SD_CMD_INPUT_REG			CARD_GPIO_INPUT
#define SD_CMD_INPUT_MASK			PREG_IO_21_MASK
#define SD_CMD_OUTPUT_REG			CARD_GPIO_OUTPUT
#define SD_CMD_OUTPUT_MASK			PREG_IO_21_MASK
    
#define SD_CLK_OUTPUT_EN_REG		CARD_GPIO_ENABLE
#define SD_CLK_OUTPUT_EN_MASK		PREG_IO_20_MASK
#define SD_CLK_OUTPUT_REG			CARD_GPIO_OUTPUT
#define SD_CLK_OUTPUT_MASK			PREG_IO_20_MASK
    
#define SD_DAT_OUTPUT_EN_REG		CARD_GPIO_ENABLE
#define SD_DAT0_OUTPUT_EN_MASK		PREG_IO_22_MASK
#define SD_DAT0_3_OUTPUT_EN_MASK	PREG_IO_22_25_MASK
#define SD_DAT_INPUT_REG			CARD_GPIO_INPUT
#define SD_DAT_OUTPUT_REG			CARD_GPIO_OUTPUT
#define SD_DAT0_INPUT_MASK			PREG_IO_22_MASK
#define SD_DAT0_OUTPUT_MASK			PREG_IO_22_MASK
#define SD_DAT0_3_INPUT_MASK		PREG_IO_22_25_MASK
#define SD_DAT0_3_OUTPUT_MASK		PREG_IO_22_25_MASK
#define SD_DAT_INPUT_OFFSET			22
#define SD_DAT_OUTPUT_OFFSET		22
    
#define SD_INS_OUTPUT_EN_REG		CARD_GPIO_ENABLE
#define SD_INS_OUTPUT_EN_MASK		PREG_IO_10_MASK
#define SD_INS_INPUT_REG			CARD_GPIO_INPUT
#define SD_INS_INPUT_MASK			PREG_IO_10_MASK
    
#define SD_WP_OUTPUT_EN_REG			CARD_GPIO_ENABLE
#define SD_WP_OUTPUT_EN_MASK		PREG_IO_11_MASK
#define SD_WP_INPUT_REG				CARD_GPIO_INPUT
#define SD_WP_INPUT_MASK			PREG_IO_11_MASK
    
#define SD_PWR_OUTPUT_EN_REG		CARD_GPIO_ENABLE
#define SD_PWR_OUTPUT_EN_MASK		PREG_IO_12_MASK
#define SD_PWR_OUTPUT_REG			CARD_GPIO_OUTPUT
#define SD_PWR_OUTPUT_MASK			PREG_IO_12_MASK
...
#define sd_sdio_enable()			{SET_PERIPHS_REG_BITS(PERIPHS_PIN_MUX_1, (0x3F<<20));SET_PERIPHS_REG_BITS(SDIO_MULT_CONFIG, (2));}
#define sd_gpio_enable()			{CLEAR_PERIPHS_REG_BITS(PERIPHS_PIN_MUX_1, (0x3F<<20));CLEAR_PERIPHS_REG_BITS(SDIO_MULT_CONFIG, (2));}
