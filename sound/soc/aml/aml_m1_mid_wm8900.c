...
/*
 * º¯ÊýÃû£ºinner_cs_input_level
 * ÓÃÍ¾£ºÊ¹ÓÃÄÚÖÃVGHL B/LµÄ·´À¡CS0/1×öÊäÈë.
 * Æ½Ì¨: AML8726-M_DEV_BOARD 2010-10-11_V1.0
 * Òý½Å£ºP4(VGHL_CS0/1)   T2(LED_CS1)  T1(LED_CS0)
 * ×¢Òâ£ºÊäÈë½ÅµÄ¸ßµçÆ½Ðè´óÓÚ0.7V£¬µÍµçÆ½ÐèÐ¡ÓÚ0.4V
 * Èë¿Ú²ÎÊý
 * ·µ»Ø²ÎÊý£º
       level[12]  <-->  VGHL_CS1ÉÏµÄÂß¼­µçÆ½
       level[ 8]  <-->  VGHL_CS0ÉÏµÄÂß¼­µçÆ½
       level[ 4]  <-->  LED_CS1ÉÏµÄÂß¼­µçÆ½
       level[ 0]  <-->  LED_CS0ÉÏµÄÂß¼­µçÆ½
 */
